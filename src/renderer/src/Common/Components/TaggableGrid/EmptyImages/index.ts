...
import empty6 from './NoItemsFound6.png'
import empty7 from './NoItemsFound7.png'
import empty8 from './NoItemsFound8.jpg'
...
export const emptyImages: EmptyImage[] = [
  ...
  { src: empty6, chance: 0.25, minViews: 10 },
  { src: empty7 },
  { src: empty8, chance: 0.1, minViews: 10 },
